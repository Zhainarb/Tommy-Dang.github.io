...
//----------------------------------------------------------------------
    /**
     Symmetric eigensystem (A-lambda*I)x = 0
     @param a - matrix A
    ...
    public static final void eigenSymmetric(double a[][], double[][] eigenvectors, double[] eigenvalues) {
        ...
        // eigenvalues and eigenvectors for system (A-lambda*I)x = 0
...
/*     Tridiagonalization of symmetric matrix.
         *     Translation of the Algol procedure tred2(),
         *     Wilkinson and Reinsch, Handbook for Automatic Computation, Vol II-Linear Algebra, (1971).
         *     Converted to Java by Leland Wilkinson November 1999.
        */
...
/*     Implicit QL iterations on tridiagonalized matrix.
         *     Translation of the Algol procedure imtql2(),
         *     Wilkinson and Reinsch, Handbook for Automatic Computation, Vol II-Linear Algebra, (1971).
