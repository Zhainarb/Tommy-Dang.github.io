...
function main(){
  if (document.getElementById("analysisTable"))
    document.getElementById("analysisTable").remove();
  if (document.getElementById("divCheckbox1"))
    document.getElementById("divCheckbox1").remove();
  if (document.getElementById("div_CRCP_PERFORMANCE"))
    document.getElementById("div_CRCP_PERFORMANCE").remove();
  if (d3.select("#graphContainer").select("svg"))
  ...
  d3.tsv("data/stress.csv", function(error, data_) {
...
function updateGraph(t){
  document.getElementById("range"+t.id).innerHTML=t.value;

  if (document.getElementById("div_CRCP_PERFORMANCE")){  // Already submitted 
    recompute(); // recompute the main function ******************
